# onyx-mobile-manager - Guide de Développement Forge

> **FICHIER GÉNÉRÉ PAR FORGE - NE JAMAIS MODIFIER**
> En cas de modification, régénérer avec: `forge regenerate-claude onyx-mobile-manager`
> Ou via API: POST /api/skills/onyx-mobile-manager/regenerate-claude
...
**IMPORTANT**: Votre code sera automatiquement validé par `curl -X POST http://10.0.0.13:4080/api/validate/onyx-mobile-manager`
...
curl -X POST http://10.0.0.13:4080/api/validate/onyx-mobile-manager | jq .
...
☐ curl -X POST http://10.0.0.13:4080/api/validate/onyx-mobile-manager = valid: true
